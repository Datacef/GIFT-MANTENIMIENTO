...
const HistorialMantenimientoPage = () => {
  ...
  return <HistorialMantenimientoContent />;
};

// ------------------------------------------------
// Content
// ------------------------------------------------
const HistorialMantenimientoContent = () => {
  const router = useRouter();
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const result = await MantenimientoService.getRegistros(filters);
    ...
    <div className="flex w-full flex-col gap-5">
      ...
      <div className="pt-5 lg:pt-10">
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Consulte todos los registros de mantenimiento realizados.
        </p>
      </div>
