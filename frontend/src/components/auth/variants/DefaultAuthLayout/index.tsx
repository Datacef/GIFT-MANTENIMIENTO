        ...
        <div className="mb-auto flex flex-col pl-5 pr-5 md:pl-12 md:pr-0 lg:max-w-[48%] lg:pl-0 xl:max-w-full">
          <NavLink href="/admin" className="mt-0 w-max lg:pt-10">
            <div className="mx-auto flex h-fit w-fit items-center hover:cursor-pointer">
              ...
              <p className="ml-3 text-sm text-gray-600">Volver al Panel</p>
            </div>
          </NavLink>
          {maincard}
          <div className="absolute right-0 hidden h-full min-h-screen md:block lg:w-[49vw] 2xl:w-[44vw]">
            ...
            >
              <div className="flex flex-col items-center justify-center text-center px-10">
                <h1 className="text-5xl font-bold text-white mb-6">Gestión de Mantenimiento</h1>
                <p className="text-2xl font-medium text-white/90 mb-2">
                  Dispositivos Médicos, Industrial e Infraestructura
                </p>
                <p className="text-lg text-white/80">
                  Acreditación en Salud — Atención Cerrada
                </p>
              </div>
            </div>
          </div>
